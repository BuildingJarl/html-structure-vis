...
export default class Element {
    ...
    createTree() {
        var testData = '<html><head></head><body>';
        testData += '<div><span></span></div>';
        testData += '<div><span></span></div>';
        testData += '<div><span></span></div>';
        testData += '<div><span><img></span></div>';
        testData += '<div><ul>';
        testData += '<li><span><a></a></span></li>';
        testData += '<li><span><a></a></span></li>';
        testData += '<li><span><a></a></span></li>';
        testData += '<li><span><a></a></span></li>';
        testData += '<li><span><a></a></span></li>';
        testData += '</div></ul>';
        testData += '<span></span><span></span><span></span><span></span><span></span>';
        testData += '</body></html>';

        parseHtmlString(testData).then( (dom) => {
    ...
    // Returns an object that can be retrieved when package is activatedl
    serialize() {
